...
public class ShowPieChartIFrame extends JFrame{   
	private static String fieldname="";
	private static String tbcontent="";
  
    public ShowPieChartIFrame(String dbname,String tbname,String Xname,String Xvalue) {   
        ...
        // createpieChart创建饼图   
        JFreeChart chart = ChartFactory.createPieChart3D("饼图",dfp, true, true, true);   
        // 图片背景色   
        chart.setBackgroundPaint(Color.red);   
        // 设置标题文字   
        ChartFrame frame = new ChartFrame("饼图 ",chart, true);   
        // 取得饼图plot对象   
        ...
        TextTitle title = new TextTitle("状态分布");   
        title.setFont(font);   
...
//    	new ShowPieChartIFrame("exceldata","qq_Sheet1","P1","P2");
//    }
