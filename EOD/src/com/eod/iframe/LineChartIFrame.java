...
public class LineChartIFrame extends JFrame{
	    ...
	    JLabel label3=new JLabel("X轴"); 
	    JLabel label4=new JLabel("Y轴");
	    ...
	    private class ShowChart implements ActionListener {
			public void actionPerformed(final ActionEvent e){
				...
				ShowLineChartIFrame linechart = new ShowLineChartIFrame("折线图",dbname,tbname,Xvalue,Yvalue);;
				linechart.pack();
