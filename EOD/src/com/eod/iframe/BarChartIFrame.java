...
public class BarChartIFrame extends JFrame{
	    ...
	    private class ShowChart implements ActionListener {
			public void actionPerformed(final ActionEvent e){
				...
				frame.setVisible(false);
				ShowBarChartIFrame barchart = new ShowBarChartIFrame(dbname,tbname,Xvalue,Yvalue);
				
			}
		}
	    
	    
	    public BarChartIFrame(){ 
