...
public class EodLoginIFrame extends JFrame {
	...
	class EodLoginAction implements ActionListener {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			if (user.getName() != null) {
				...
				try {
					...
					EodLoginIFrame.this.setVisible(false);
				} catch (Exception ex) {
					ex.printStackTrace();
				}
			} else {
	...
	public EodLoginIFrame() {
		...
		login=new JButton();
		login.addActionListener(new EodLoginAction());
